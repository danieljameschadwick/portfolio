...
export const Attributes: React.FC = () => {
  return (
    <div
      className={"attributes-container container mt-12 mb-10 mx-auto w-9/12"}
    >
      <div className={"attributes"}>
        ...
        <Attribute
          ...
          studying={["NestJS", "MikroORM"]}
        />

        <Attribute
          title={"DevOps"}
          caption={
            "Developing web applications using Amazon S3, CloudWatch and CloudFront."
          }
          skills={[
            "AMQP (RabbitMQ)",
            "Docker",
          ...
          studying={["Advanced AMQP", "AWS Lambda"]}
        />
      </div>
    </div>
  );
